...
-- Helpful indexes
CREATE INDEX idx_voice_transcripts_user_id ON public.voice_transcripts(user_id);
CREATE INDEX idx_voice_transcripts_call_id ON public.voice_transcripts(call_id);
