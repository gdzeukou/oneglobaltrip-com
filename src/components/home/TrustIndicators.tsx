  ...
  return (
    <section className="py-16 bg-gradient-to-r from-gold-500 via-gold-400 to-gold-500 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-brand-800 font-semibold text-lg font-inter">
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <div className="glass bg-white/20 backdrop-blur-md rounded-2xl p-6 border border-white/30 hover:bg-white/25 transition-all duration-300">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              {certifications.map((cert, index) => (
                <div 
                  key={index}
                  className="flex items-center space-x-2 glass bg-white/30 backdrop-blur-sm rounded-full px-4 py-2 hover:bg-white/40 transition-all duration-300 transform hover:scale-105"
                >
