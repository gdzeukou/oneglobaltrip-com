...
import { getFinlandLongStayRequirementsByCategory, getAllFinlandLongStayCategories, RequirementItem } from '@/utils/finlandLongStayRequirements';

interface FinlandLongStayRequirementsProps {
...
const FinlandLongStayRequirements = ({ selectedCategory = 'Work', onCategoryChange }: FinlandLongStayRequirementsProps) => {
  const categories = getAllFinlandLongStayCategories();
  const requirements = getFinlandLongStayRequirementsByCategory(selectedCategory);
    ...
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-6 text-gray-900">
          Finland Long-Stay Visa Requirements
        </h2>
        ...
        <Tabs value={selectedCategory} onValueChange={onCategoryChange} className="w-full">
          <TabsList className="grid w-full grid-cols-1 lg:grid-cols-3 gap-1">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        <h4 className="font-bold text-yellow-800 mb-2 flex items-center gap-2">
          ...
          Important Notes for Finland Long-Stay Visa
        </h4>
        <ul className="text-sm text-yellow-700 space-y-1">
          <li>• All documents must be apostilled or legalized</li>
          <li>• Health insurance must include mental health coverage</li>
          <li>• Finnish language learning encouraged for integration</li>
          <li>• Processing times may vary by location</li>
...
export default FinlandLongStayRequirements;
