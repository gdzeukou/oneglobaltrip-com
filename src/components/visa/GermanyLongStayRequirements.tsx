...
import { getGermanyLongStayRequirementsByCategory, getAllGermanyLongStayCategories, RequirementItem } from '@/utils/germanyLongStayRequirements';

interface GermanyLongStayRequirementsProps {
...
const GermanyLongStayRequirements = ({ selectedCategory = 'Work', onCategoryChange }: GermanyLongStayRequirementsProps) => {
  const categories = getAllGermanyLongStayCategories();
  const requirements = getGermanyLongStayRequirementsByCategory(selectedCategory);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-red-50 to-black/5 border border-red-200 rounded-lg p-6">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        <h4 className="font-bold text-yellow-800 mb-2 flex items-center gap-2">
          ...
          Important Notes for Germany Long-Stay Visa
        </h4>
        <ul className="text-sm text-yellow-700 space-y-1">
          <li>• All documents must be apostilled and translated</li>
          <li>• Health insurance must meet Krankenversicherung standards</li>
          <li>• Blocked account required for students (€11,208+ annually)</li>
          <li>• Integration courses mandatory for some visa types</li>
...
export default GermanyLongStayRequirements;
