          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button 
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    // Don't clear loading on success - let callback handle it
                  } catch (error: any) {
              ...
              >
                ...
                {socialLoading === 'google' ? 'Signing in with Google...' : 'Google'}
              </Button>
              ...
              >
                ...
                {socialLoading === 'facebook' ? 'Signing in with Facebook...' : 'Facebook'}
              </Button>
            </div>
